...
export default function Home() {
  ...
  const birthdayDate = new Date("July 03, 2025") // Change this date accordingly
  const audioRef = useRef(null)

  // For testing
  // const birthdayDate = new Date("2025-06-15T22:03:00+05:00")
  ...
  useEffect(() => {
    const generated = Array.from({ length: 20 }).map(() => ({
      ...
      top: `${Math.random() * 100}%`,
      color: ["bg-red-200", "bg-yello-300", "bg-purple-300", "bg-violet-300", "bg-rose-300"][Math.floor(Math.random() * 3)],
